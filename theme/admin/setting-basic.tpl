                            ...
                            <div class="card">
                                ...
                                <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">当前模板</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <?php echo $theme ?>
                                            </div>
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">选择模板</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <select name="themeName" id="SelectLm" class="form-control-sm form-control">
                                    ...
                                    <div class="card-footer">
                                        <button name="setting-4" type="submit" class="btn btn-primary btn-sm">
                                            <i class="fa fa-dot-circle-o"></i> 修改
                                        </button>
                                    </div>
                                </form>
